...
using D2_AspNet5StarterWeb.Models;

namespace D2_AspNet5StarterWeb.Migrations
{
    [ContextType(typeof(D2_AspNet5StarterWeb.Models.ApplicationDbContext))]
    public class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override IModel Model
        {
            get
            {
                ...
                builder.Entity("D2_AspNet5StarterWeb.Models.ApplicationUser", b =>
                {
                ...
                builder.Entity("Microsoft.AspNet.Identity.IdentityUserClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]", b =>
                {
                    b.ForeignKey("D2_AspNet5StarterWeb.Models.ApplicationUser", "UserId");
                });
